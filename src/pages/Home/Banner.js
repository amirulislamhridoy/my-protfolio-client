...
const Banner = () => {
  ...
  return (
    <section className="group flex items-center h-screen">
      <div className="flex-1 flex flex-col justify-center h-full">
        ...
        <button
          ...
          class="btn btn-outline btn-accent w-24"
        >
          Resume
        </button>
      </div>
      ...
      <div className="flex-1 relative">
        <img
          className=" max-w-xl absolute left-2/4 translate-x-[-50%] translate-y-[-50%] group-hover:translate-y-[-40%] group-hover:duration-500 ease-in-out"
          src={img1}
          alt="pattern"
        />

        <img
          className="absolute left-2/4 translate-x-[-50%] translate-y-[-50%]"
          src={img2}
          alt="Employee"
        />
      </div>
